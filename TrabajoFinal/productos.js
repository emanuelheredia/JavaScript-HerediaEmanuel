...
//Función que imprime en Tienda todos los productos almacenados en el Local Storage
...
//Evento Click en la opción de filtro por marca que imprime lo productos que cumplen la condición
$("#filtroMarca").click(()=>{
...
//Función filtra los producto según marca selecionada por el Usuario.
...
//Función que incluye productos añadidos por el usuario al Carrito y Local Storage. 
...
//Función que obtiene el precio total de los productos añadidos al carrito
const sumarCarrito=()=>{
...
//Evento sobre el botón finalizar compra que brinda mensaje en pantalla con el detalle de la misma
$("#btnFinalizar").click(()=>{
...
//Función que imprime en ventana modal de Carrito los productos parcialmente añadidos
...
//Llamada Ajax mediante JQuery para incluir comentarios de Reseña en página Tienda
